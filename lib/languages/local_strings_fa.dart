...
class LocalStringsFa extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'fa_AF': {
      ...
      'quiz_list': 'فهرست از بازیها لغتی',
      ...
      'group': 'گروه: ',
      'create_group_title': 'مشخصات گروه را انتخاب کن',
      ...
      'request_friendship' : 'درخواست دوستی',
      ...
      'group_membershit_succed' : 'با موفقیت عضو گروه شدی',
      ...
      'btn_create': 'ثبت کن',
      'btn_login' : 'ورود',
      'btn_membershipt_request' : 'درخواست عضویت',
      'btn_accept' : 'تایید',
      'btn_decline': 'رد کن ',
      ...
      'policy_data_security_and_thirdparty_description_part1': 'ما اطلاعات شخصی شما را با هیچ شرکت ثالثی به اشتراک نمی‌گذاریم، نمی‌فروشیم و توزیع نمی‌کنیم. اطلاعات شما تنها برای ارائه خدمات از طریق اپلیکیشن بازار بازی استفاده می‌شود.',
      ...
      'policy_agreement_description': 'با استفاده از اپلیکیشن بازار بازی، شما تأیید و با این سیاست حفظ حریم خصوصی موافقت می‌کنید. ما توصیه می‌کنیم که این سیاست را به‌طور منظم بررسی کنید، زیرا ادامه استفاده از اپلیکیشن به معنای پذیرش هرگونه تغییر یا به‌روزرسانی آن است.',
