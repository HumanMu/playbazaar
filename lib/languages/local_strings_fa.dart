...
class LocalStringsFa extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'fa_IR': {
      ...
      "player_not_found": "بازیکن در این بازی پیدا نشد",
      'players': 'بازیکن',
      ...
      "leaving_game_succeeded": "شما با موفقیت از بازی خارج شدید",
      'game_code': 'کد بازی',
...
هرگونه سخنان نفرت‌آمیز، تبعیض، آزار و اذیت، یا به اشتراک‌گذاری محتوای توهین‌آمیز یا نامناسب به شدت ممنوع است. بحث‌هایی که شامل نژادپرستی، جنسیت‌گرایی یا موضوعات حساس باشند، می‌تواند به پیامدهایی مانند محدودیت موقت یا دائمی برای شرکت در گروه‌ها یا ارسال پیام‌های خصوصی منجر شود.       
      ...
      // Ludo
      'ludo_home_screen_guide_title': 'لودو ماموریت',
      'ludo_game_start_guide': 'برای شروع بازی تیمی، لطفاً یا ربات‌ها را فعال کنید یا ۴ بازیکن انتخاب نمایید.',
      "ludo_home_screen_guide": "صفحه اصلی پنج گزینه برای انتخاب ارائه می‌دهد که چهار گزینه آن : ۲، ۳ و ۴ بازیکن که نمایانگر تعداد شرکت‌کنندگان است. اگر کمتر از چهار نفر هستید، می‌توانید گزینه «فعال‌سازی ربات‌ها» را انتخاب کنید تا مکان‌های خالی پر شوند. در غیر این صورت، اگر تنها بازی می‌کنید و می‌خواهید مقابل کامپیوتر بازی کنید، می‌توانید گزینه «کامپیوتر» را انتخاب کنید بدون اینکه نیازی به فعال‌سازی ربات‌ها باشد.\n\n گزینه دیگر «بازی گروهی» است. با انتخاب این گزینه هر گروه شامل ۲ بازیکن می‌شود که برای برنده شدن باید گروه رقیب را شکست دهد.\n\n ** گزینه با دوستان آنلاین ** \n\n این گزینه صفحه جدیدی باز می‌کند که شامل دو گزینه جدید است --> «ورود با کد» و «بازی جدید»\n\n «ورود با کد» گزینه‌ای است که کدی را که از دوستان خود گرفته‌اید وارد می‌کنید و دکمه ورود را فشار می‌دهید تا وارد بازی شوید.\n\n گزینه بعدی «بازی جدید» است که اگر آن را فشار دهید، یک بازی جدید آغاز می‌کنید که یک کد ۶ حرفی می‌سازد و آن را با دوستان خود شریک می‌سازید تا وارد بازی شما شوند."
    }
  };
}
