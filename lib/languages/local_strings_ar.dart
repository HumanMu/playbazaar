...
class LocalStringsAr extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ar_SA': {
      ...
      "player_not_found": "لم يتم العثور على اللاعب في هذه اللعبة",
      'players': 'اللاعبون',
      ...
      "leaving_game_succeeded": "لقد غادرت اللعبة بنجاح",
...
باستخدامك لهذه الميزات، فإنك توافق على الالتزام بهذه القواعد والمساهمة في خلق بيئة إيجابية ومحترمة للجميع.        ''',
      ...
      ** بدون خيارات **  
      ...
      "ludo_home_screen_guide": "تعرض الشاشة الرئيسية خمسة خيارات، أربعة منها هي: لعب بـ 2 أو 3 أو 4 لاعبين، والتي تمثل عدد المشاركين. إذا كنتم أقل من أربعة لاعبين، يمكنكم تفعيل خيار «الروبوتات» لملء الأماكن الفارغة. أما إذا كنت تلعب وحدك وترغب في اللعب ضد الكمبيوتر، فيمكنك اختيار «الكمبيوتر» دون الحاجة إلى تفعيل الروبوتات.\n\n خيار آخر هو «اللعب الجماعي». عند اختيار هذا الخيار يتكوّن كل فريق من لاعبين اثنين، وللفوز يجب على فريقك هزيمة الفريق المنافس.\n\n ** اللعب مع الأصدقاء عبر الإنترنت ** \n\n يفتح هذا الخيار صفحة جديدة تحتوي على خيارين جديدين --> «إدخال الكود» و«لعبة جديدة»\n\n «إدخال الكود» هو الخيار الذي تدخل فيه الكود الذي حصلت عليه من أصدقائك ثم تضغط زر الدخول للانضمام إلى اللعبة.\n\n الخيار التالي هو «لعبة جديدة» حيث يؤدي الضغط عليه إلى بدء لعبة جديدة وإنشاء كود مكوّن من 6 أحرف. شارك هذا الكود مع أصدقائك ليتمكنوا من الانضمام إلى لعبتك."
