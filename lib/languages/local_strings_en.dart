...
class LocalStringsEn extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'enter_game_code': 'Enter the game code shared by your friend:',
      'create_and_invite_friend': 'Create and invite friends',
      'you_will_receive_code': 'By pressing on \'New Game\' you will receive a game code that you can share with your friends to invite them to join you!',
      ...
      'compete_offline': 'With friends - offline',
      'compete_online': 'With friends - online',
      ...
      "leaving_game_succeeded": "You left the game successfully",
      'game_code': 'Game Code',
      ...
      'exact_code_limit': 'The code length must be exactly %1 characters',
      ...
      ** Without Options **  
      ...
      "ludo_home_screen_guide": "The home screen offers five options, four of which are: 2, 3, and 4 players, representing the number of participants. If you are fewer than four players, you can enable the ‘Robots’ option to fill the empty spots. Otherwise, if you are playing alone and want to play against the computer, you may select the ‘Computer’ option without needing to enable robots.\n\n Another option is ‘Team Play’. By selecting this, each team consists of 2 players, and to win, your team must defeat the opposing team.\n\n ** Online Play With Friends ** \n\n This option opens a new screen that contains two new choices --> ‘Enter Code’ and ‘New Game’\n\n ‘Enter Code’ is the option where you enter the code you received from your friends and press the join button to enter the game.\n\n The next option is ‘New Game’, where pressing it creates a new game and generates a 6-character code. Share this code with your friends so they can join your game."
    }
  };
