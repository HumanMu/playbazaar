...
class LocalStringsDa extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'dk_DK': {
      ...
      'enter_game_code': 'Indtast spil-koden, som din ven har delt med dig:',
      'create_and_invite': 'Opret og inviter venner',
      'you_will_receive_code': 'Når du trykker på \'Nyt spil\', vil du modtage en spil-kode, som du kan dele med dine venner for at invitere dem til at deltage!',
      ...
      'compete_offline': 'Med venner - offline',
      'compete_online': 'Med venner - online',
      ...
      "player_not_found": "Spilleren blev ikke fundet i dette spil",
      'players': 'Spillere',
      ...
      "leaving_game_succeeded": "Du har forladt spillet",
      'game_code': 'Spilkode',
      ...
      'exact_code_limit': 'Koden skal være præcis %1 tegn lang',
      ...
      "ludo_home_screen_guide": "Startskærmen giver fem valgmuligheder, hvoraf fire er: 2, 3 og 4 spillere, som viser antallet af deltagere. Hvis I er færre end fire spillere, kan I aktivere ‘Robotter’ for at fylde de tomme pladser. Hvis du spiller alene og ønsker at spille mod computeren, kan du vælge ‘Computer’ uden at aktivere robotter.\n\n En anden mulighed er ‘Holdspil’. Når du vælger dette, består hvert hold af 2 spillere, og for at vinde skal dit hold besejre modstanderholdet.\n\n ** Online spil med venner ** \n\n Denne mulighed åbner en ny side, som indeholder to nye valg --> ‘Indtast kode’ og ‘Nyt spil’\n\n ‘Indtast kode’ er valgmuligheden, hvor du indtaster den kode, du har fået fra dine venner, og trykker på knappen for at komme ind i spillet.\n\n Den næste mulighed er ‘Nyt spil’, hvor du ved at trykke på knappen starter et nyt spil, der genererer en 6-cifret kode. Del denne kode med dine venner, så de kan deltage i dit spil."
